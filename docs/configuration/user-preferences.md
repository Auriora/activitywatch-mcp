...
4. **Verify** by running a daily summary
...
3. **Check the output** - Daily summaries should show timezone in header: `Daily Summary for 2025-10-11 (Europe/Dublin)`
4. **Check console logs** - Look for `[UserPreferences] Loaded preferences: timezone=...`
